...
use QuickBooks\Utility\IntuitErrorHandler;
...
class SyncRestHandler extends RestHandler
{
    ...
    private function GetOAuthResponseHeaders($oauth)
    {
        ...
        return [$response_code, $response_xml, $response_headers];
    }
    ...
    public function GetResponse($requestParameters, $requestBody, $oauthRequestUri)
    {
        ...
        if ('QBO' == $this->context->serviceType ||
            ...
            // IDS call
            $httpHeaders = ['host' => parse_url($requestUri, PHP_URL_HOST),
            ...
            // IPP call
            $httpHeaders = ['user-agent' => CoreConstants::USERAGENT];
        }
...
//		echo "$response_xml\n";
    ...
    private function CallRestService($requestParameters, $requestBody, $oauthRequestUri)
    {
        ...
        return [$httpWebResponseCode, $httpParsedWebResponseBody];
    }
